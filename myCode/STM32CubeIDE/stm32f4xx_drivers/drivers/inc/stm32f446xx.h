...
/*
 * Base addresses of peripherals which are changing on AHB1 bus
 ...
 * e.g: Num of Registers of SPI peripheral of STMF4xx family may be different more or less
 * regarding the number of registers of SPI peripherals of STM32F0XX family of MCUs
 * Check the MCU RM
 */

/*
 * peripheral register definition sctructure for GPIO
 */
...
typedef struct {
	...
	__vo uint32_t AFR[2];		/*!< GPIO alternate function Address Offset Registers: 0x20-0x24 */
} GPIO_RegDef_t;
...
/*
 * peripheral register definition sctructure for RCC
 */
...
/*
 * peripheral definitions (peripheral base addresses typecasted to regdef struct
 */
...
/*
 * IRQ(Interrupt Request) Numbers of STM32F4467x MCU
